...
@Component({
  selector: 'app-root',
  standalone:true,
  imports: [RouterOutlet, Navbar, MyData, ],
...
export class AppComponent {
  ...
  constructor(private breakpointObserver: BreakpointObserver) {
    ...
    this.breakpointObserver.observe([
      ...
      if (state.breakpoints['(max-width: 379px)'] || state.breakpoints['(min-width: 280px) and (max-width: 399px)'] || state.breakpoints['(min-width: 577px) and (max-width: 750px)']) {
